...
Route::get('/signup-success-free-plan', function () { return view('signup-success-free-plain'); });
...
Route::get('/company-signup', function () { return view('signup'); });
Route::get('/term-of-use', function () { return view('terms-of-use'); });
