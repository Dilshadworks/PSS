...
<!-- ==== Page Testimonial (Desktop version) === -->
<main>
    <section class="page-testimonial d-lg-block d-none">
        <div class="tetimonial-header">
            <div class="custom_container">
                <div class="row">
                    <div class="col col-md-6 text-center">
                        <img class="img-fluid" src="/images/otter-testimonial.png">
                    </div>
                ...
                <div class="col-12">
                    <div class="widget-shadow">
                        ...
                        <div class="d-inline-block mt-4 mb-4">
                            <a href="/company-signup" type="button" class="btn ms-auto text-white font_20 linehight_23 b-100-radious md-btn secondary_color_bg">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- ==== Page Testimonial (Mobile version) === -->
    <section class="mobile-page-testimonial d-blcok d-lg-none">
        <div class="container">
            <img class="img-fluid in-center py-4" src="/images/otter-testimonial-mobile.svg" alt="mobile attr">
            <div class="circle pb-2 in-center">
                <img class="img-fluid" src="/images/ellipse.png">
                <img class="img-fluid" src="/images/ellipse.png">
                <img class="img-fluid" src="/images/ellipse.png">
            </div>
            <h3 class="primary_color_text tag-title m-0 in-center">We Work Hard</h3>
            <h3 class="secondary_color_text tag-title m-0 pb-4 in-center">to Gain Your Trust</h3>
        </div>
        <!-- Testimonial Slider -->
        <div class="silk-mobile-slider">
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">We've tried other apps, but PSS is our last. It is so easy to use with our employees, customers &amp; tracking. Customer service is exceptional &amp; quick.
                            </p>
                            <strong class="grey font_12 linehight_14 d-block">Richard &amp; Terri Schwenzer</strong>
                            <strong class="grey font_12 linehight_14 d-block">(Hawaii) Blue Water Pool &amp; Spa</strong>
                        </div>
                    </div>
                </div>
                <div class="p-2">
                    <div class="card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">PSS is amazing. I was looking for an app like this one. I was doing all my work on a paper, even chemical readings and dosages. Also I was sending text messages to clients when they were late, now I don’t have to worry about anything. It makes my life easier and what I like is how the PSS team is always improving the app. I have been using it for a while now. Thank you!</p>
                            <strong class="grey font_12 linehight_14 d-block">Adonis (Georgia)</strong>
                            <strong class="grey font_12 linehight_14 d-block">Adonis Pool Service</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">PSS has been a game changer for my business. It has allowed me to become way more organized, stay on top of billing and to effortlessly communicate with my clients. My techs and I enjoy using the user-friendly interface. I’ve been on several platforms and PSS is the first that I have truly enjoyed using.</p>
                            <strong class="grey font_12 linehight_14 d-block">Dean Ouellette (Arizona)</strong>
                            <strong class="grey font_12 linehight_14 d-block">Big Family Pools</strong>
                        </div>
                    </div>
                </div>
                <div class="p-2">
                    <div class="card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">Great app with awesome support! Well put together app that is easy to use to run my pool service business. The reports look great and are very customizable. They also have support for QuickBooks, but you can also just use their invoicing in case you don’t have QB or want to ditch QB. The customer support is excellent, thank you!</p>
                            <strong class="grey font_12 linehight_14 d-block">RayV77</strong>
                            <strong class="grey font_12 linehight_14 d-block">IOS User</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">Awesome Pool App!
                                This app is everything I need to run my pool business, in one central location! Very well done, clean and easy to use.
                                Love the jobs feature!!!
                            </p>
                            <strong class="grey font_12 linehight_14 d-block">Petitpounne</strong>
                            <strong class="grey font_12 linehight_14 d-block">IOS User</strong>
                        </div>
                    </div>
                </div>
                <div class="p-2">
                    <div class="card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">Love it!
                                Moved my entire company from PTPM to PSS. So glad I did! Their customer service is TOP NOTCH. Software improvements come out faster than others I’ve tried over the last few years. And they take every suggestion for feature or tweaks to heart and see if it’ll will for the overall experience. You won’t be disappointed.
                            </p>
                            <strong class="grey font_12 linehight_14 d-block">Trav2001 </strong>
                            <strong class="grey font_12 linehight_14 d-block">IOS User</strong>
                        </div>
                    </div>
                </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card single-card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">I researched carefully and tried 2-3 other route management software platforms before discovering and settling on PSS. While they all have some great benefits and features, PSS has been extremely simple and easy to use in every way. It is a massive time saver with literally all of our route, jobs, and invoicing set on autopilot, assigning routes & jobs to techs, completing tasks, and if there are scheduling changes I can simply shoot an Announcement out to specific clients to let them know what is happening. Overall, between the features, intuitive updates, and customer support, PSS is an amazing platform!</p>
                            <strong class="grey font_12 linehight_14 d-block">Jeff Wolf (California)</strong>
                            <strong class="grey font_12 linehight_14 d-block">Sunset Pool Service</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card single-card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">Ever since I started using Pool Service Software, it has made managing my route and client invoicing much easier. The unique features it has is a testimony of the personal interest and attention that its developers have achieved. Their attention to detail and response to feedback shows that they really have the pool pro at heart. Using things such as the LSI, customizable letters and invoicing, having a shopping list makes this a worthwhile tool in the pool pros "toolbox". While there are many platforms available, Pool Service Software has truly been at the very top. If you're not sure, try its free trial plan. You can't lose! But, once you try it, you won't want to try anything else!</p>
                            <strong class="grey font_12 linehight_14 d-block">Joel T. (California)</strong>
                            <strong class="grey font_12 linehight_14 d-block">Hokulea Pool Service & Repair</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card single-card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">Excellent Customer Service!
                                This app is definitely responsible for a lot of my company’s success so far. It makes running a pool service company easy and simple. Just like any app I have seen a bug here or there, but their customer service is so good. They pushed out an update to fix the issue within 24hrs and were in communication with me the entire time. I highly recommend using this app, you won’t regret it.</p>
                            <strong class="grey font_12 linehight_14 d-block">mcginnessdr</strong>
                            <strong class="grey font_12 linehight_14 d-block">IOS User</strong>
                        </div>
                    </div>
                </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card single-card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">I started my business with PSS and couldn’t imagine operating a pool service business without it!
                                My customers love the detailed service reports and how easy it is to pay their invoices.
                                For pool guys/gals it doesn’t get any easier to keep track of and manage your customer’s pools, invoices, and your business’s P&L.
                                I love the service and the cost is very reasonable compared to other platforms….5 stars!!!
                            </p>
                            <strong class="grey font_12 linehight_14 d-block">Brendan(Arizona)</strong>
                            <strong class="grey font_12 linehight_14 d-block">Red Fox Pools, LLC</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-nav">
                <div class="p-2">
                    <div class="card single-card">
                        <div class="card-body text-center">
                            <img class="img-fluid pb-3 m-auto" src="images/stars.svg" alt="Stars">
                            <p class="linehight_19 font_12 dark_gray m-0">PSS is a must have for any pool service company. It is easy for customers to use (via the customer portal) as well as helping to get my business organized. It has great features, including text alerts for services, and billing is smooth, which all my customers appreciate. PSS is outstanding with their customer service and I believe this truly sets them apart from the competition. Don't settle and get the best!</p>
                            <strong class="grey font_12 linehight_14 d-block">Richard Sousa(Arizona)</strong>
                            <strong class="grey font_12 linehight_14 d-block">Bottom Feeder Pool Care</strong>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-5 mb-3">
            <h3 class="primary_color_text font_22 linehight_26">Ready To Join?</h3>
            <p class="font_12 linehight_19 my-3">No Contracts. No Commitments. Cancel Anytime.</p>
